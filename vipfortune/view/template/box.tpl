...
<div id="guidanceBox" style="display:none; z-index:999; left:50%; top:15%; margin-left:-381px!important; margin-top:-60px!important; margin-top:0px; position:fixed!important;/* FF IE7*/   position:absolute;/*IE6*/  _top: expression(eval(document.compatMode && document.compatMode=='CSS1Compat') ? documentElement.scrollTop + (document.documentElement.clientHeight-this.offsetHeight)/2 :/*IE6*/ document.body.scrollTop + (document.body.clientHeight - this.clientHeight)/2);/*IE5 IE5.5*/">
	<div class="tipbox box2">
		...
		<div class="tip_c">
			<div class="tip_con">
				<div class="guidetab clearfix">
					<a href="javascript:;" class="gtab1 on">Wheel of Fortune</a>
					<a href="javascript:;" class="gtab2">VIP Sprint</a>
				</div>	
				<div class="gcont gcont1">
				...
				<div class="gcont gcont2" style="display:none;">
					<div class="infoscroll2">
						<h4>VIP Sprint</h4>
						...
						<p><em>Note: VIP 7+ indicates that after you reach VIP Level 7 and you credit $2,000 USD to your account every time, you'll be rewarded, every time! All VIP 7 heroes who received a Super Honor Pack will be rewarded with a Permanent Freedom Suit after the event ends.</em></p>
						<ol>
